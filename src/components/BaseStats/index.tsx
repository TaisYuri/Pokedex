...
export const BaseStats = ({ dataPoke }: IBaseStats) => {
    return (
        <Container>
            ...
            <Stats>
                <Image source={{ uri: 'https://cdn-icons-png.flaticon.com/512/188/188985.png' }} style={{ width: 30, height: 30 }} />
            ...
            <Stats>
                <Image source={{ uri: 'https://cdn-icons-png.flaticon.com/512/188/188934.png' }} style={{ width: 30, height: 30 }} />
            ...
            <FleeRate>
                <Image source={{ uri: 'https://cdn-icons-png.flaticon.com/512/188/188966.png' }} style={{ width: 40, height: 40, marginRight: 20,  transform: [{ rotate: '-90deg' }] }} />
